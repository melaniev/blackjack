		...
		<div id='home-page-login-container'>
			<form action="/lobby.php" method="post" name='blackjack-signup'>
				...
				<div id='pretty-login'>
					...
					<span class='login-label'>password: </span><input type='password' name='signup-password' class='login-input' id='login-password'/><br />
					<span class='login-label'>password, again: </span><input type='password' name='signup-password-2' class='login-input' id='login-password-2'/><br />
